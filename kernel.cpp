...
void printf(int8_t* str)
{
    ...
    reinterpret_cast<uint16_t*>(0xb8000);  //在内存中从该地址开始对应屏幕，每个字符有两个字节，
...
extern "C" void kernelMain(void* multibootStructure,uint32_t magicNumber)   //extern "C"让编译器按照c语言的链接约定编译该函数
